                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          ...
                          <div className="text-center">
                            <p className="font-semibold text-sm">采购商</p>
                            <p className="text-xs text-muted-foreground mt-0.5">
                              我要开启跨境电商
                            </p>
                          </div>
              ...
              {step === "info" && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button
                        ...
                        className="min-w-[100px] rounded-lg text-sm h-9 font-medium"
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Building2 className="absolute left-3 top-1/2 transform -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground" />
                      <Input
                        id="company"
                        placeholder={
                          role === "vendor"
              ...
              <div className="flex gap-3 w-full">
                {step !== "role" && (
                  <Button
                    type="button"
                    variant="outline"
                    className="flex-1 rounded-lg text-sm h-9 font-medium hover:bg-gray-100"
                    onClick={prevStep}
                  >
                ...
                <Button
                  type="button"
                  className="flex-1 rounded-lg text-sm h-9 font-medium shadow-md hover:shadow-lg"
                  disabled={loading}
                  onClick={step === "password" ? handleRegister : nextStep}
                >
                  {step === "password" ? (
                    loading ? (
