...
async function getSupplierProducts(supplierId: string): Promise<SupplierProduct[]> {
  // TODO: Replace with actual API call
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-4">
                    <p className="text-sm text-muted-foreground">供应商代码：{supplier.code}</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    <p className="text-2xl font-bold">{supplier.qualityScore}</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-2xl font-bold">{supplier.totalOrders.toLocaleString()}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    <p className="text-2xl font-bold">{supplier.deliveryRate}%</p>
                  </div>
                </div>
              </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-medium text-muted-foreground">响应速度</p>
                  <div className="mt-1 flex items-center gap-2">
            ...
            <CardContent>
              ...
              <div className="mt-6 grid gap-6 sm:grid-cols-2">
                <div className="space-y-1">
                  <p className="text-sm font-medium text-muted-foreground">主营类目</p>
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium text-muted-foreground">认证资质</p>
                  <div className="flex flex-wrap gap-2">
          ...
          <Tabs defaultValue="products" className="space-y-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-center justify-center py-8">
                    <p className="text-sm text-muted-foreground">采购订单功能开发中...</p>
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
            <TabsContent value="analytics">
              <Card>
                ...
                <CardContent>
                  <div className="flex items-center justify-center py-8">
                    <p className="text-sm text-muted-foreground">数据分析功能开发中...</p>
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">{supplier.establishedYear}年</p>
              ...
              <CardContent>
                <div className="space-y-4">
                  {products
                    ...
                    .slice(0, 5)
                    .map(product => (
                      <div key={product.id} className="group flex items-start gap-3">
                        <Image
                          src={product.image}
